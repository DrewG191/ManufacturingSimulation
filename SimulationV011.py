...
targets = [12, 8, 8, 22, 1, 50, 157, 9999, 9999, 9999, 9999, 9999, 9999] #input values for quantities of machines and buffer maximum limits
...
includebuffer = 0 #Variable to determine whether or not to include buffers (2 is a placeholder value, used as a multiplier with values of either 0 or 1)
