...
targets = [13, 9, 9, 25, 1, 11, 46, 9999, 9999, 9999, 9999, 9999, 9999] #Machine Quantities, Worker Quantity, and Max Buffer Sizes
...
for step in teststeps:
    ...
    for a,b,c,d,e,f,g,h,u,o,k,l,m in options:       
        ...
        if meanProducts >= productiongoal:
            ...
            viable.append([round(meanCost+9900000000.00,2),products,package,moneyz])
