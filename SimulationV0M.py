...
hoursoperational = 9 #How many hours per day is it operational?
workertype = 2 #What type of worker assembly process is in use?
targets = [20, 10, 10, 30, 10, 10, 100, 9999, 9999, 9999, 9999, 9999, 9999] #input values for quantities of machines and buffer maximum limits
...
includebuffer = 2 #Variable to determine whether or not to include buffers (2 is a placeholder value, used as a multiplier with values of either 0 or 1)
